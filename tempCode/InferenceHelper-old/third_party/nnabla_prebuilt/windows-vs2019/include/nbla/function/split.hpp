...
/** Split
 */
#ifndef __NBLA_FUNCTION_SPLIT_HPP__
#define __NBLA_FUNCTION_SPLIT_HPP__
 ...
 */
template <typename T> class Split : public BaseFunction<int> {
protected:
  int axis_;
  int num_outputs_;
...
public:
  Split(const Context &ctx, int axis) : BaseFunction(ctx, axis), axis_(axis) {}
  virtual ~Split() {}
